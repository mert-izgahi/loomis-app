    ...
    return (
        <AnimatedCardsContainer className="bg-muted p-4 flex items-center justify-center h-64 rounded-md">
            <div className="max-w-xl flex flex-col gap-3 p-4">
                ...
                Teknisyen Aktivite Raporu
                </h1>
                <p className="text-xs">
                    Teknisyenlerin günlük veya haftalık bazda tamamladığı, bekleyen ve iptal edilen iş emirlerini listeler. Bireysel performans takibi için uygundur.
                </p>
